...
public class OAuth2ServerConfig {
	...
	private static final int ACCESS_TOKEN_VALIDATE_SECONDS=60*60;  //access_toke有效期12小时，也是默认的时间
	private static final int REFRESH_TOKEN_VALIDATE_SECONDS=60*60;//refresh_token有效期7天，默认是30天
