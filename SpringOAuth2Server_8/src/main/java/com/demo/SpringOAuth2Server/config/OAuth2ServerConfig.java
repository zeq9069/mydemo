...
public class OAuth2ServerConfig {
	...
	protected static class ResourceServerConfig extends ResourceServerConfigurerAdapter{
		...
		public void configure(HttpSecurity http) throws Exception {
			http
				...
				.and()
				.authorizeRequests()
					.antMatchers("/home/client/**").access("#oauth2.isClient() or #oauth2.hasScope('info_read')")//or hasRole('ROLE_USER') or #oauth2.hasScope('info_read')
	...
	protected static class OAuth2Server extends AuthorizationServerConfigurerAdapter{
		...
		//自定义approvalStore成bean，在Controller可以获取
		@Bean
