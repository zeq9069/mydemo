package com.demo.SpringOAuth2Server.client.consume;
...
/**
 * 自定义 AuthorizationCodeAccessTokenProvider 
 * 
 * 用来更改请求参数的名称
 * 
 * @author zhangerqiang
 *
 */
public class ConsumeWeixinAuthorizationCodeAccessTokenProvider extends OAuth2AccessTokenSupport implements AccessTokenProvider{
